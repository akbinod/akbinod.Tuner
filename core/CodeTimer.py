...
class CodeTimer:
    ...
    def __str__(self) -> str:
        ...
        this = None
        if self.elapsed_time is None or self.elapsed_proc_time is None:
            # happens when a downstream proc bombs
            pass
        else:
            this = (time.strftime('%H:%M:%S', self.elapsed_time ),round(self.elapsed_proc_time,self.precision))
